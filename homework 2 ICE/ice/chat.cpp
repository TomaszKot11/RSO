...
const ::std::string iceC_Chat_Room_ChangePassword_name = "ChangePassword";
...
/// \cond INTERNAL
bool
Chat::Room::_iceD_ChangePassword(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::OperationMode::Normal, current.mode);
    auto istr = inS.startReadParams();
...
/// \cond INTERNAL
void
Chat::RoomPrx::_iceI_AddUser(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::std::shared_ptr<UserPrx>& iceP_who, const ::std::string& iceP_password, const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
Chat::RoomPrx::_iceI_ChangePassword(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::std::shared_ptr<UserPrx>& iceP_user, const ::std::string& iceP_oldpassword, const ::std::string& iceP_newpassword, const ::Ice::Context& context)
{
    _checkTwowayOnly(iceC_Chat_Room_ChangePassword_name);
    outAsync->invoke(iceC_Chat_Room_ChangePassword_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        [&](::Ice::OutputStream* ostr)
        {
...
/// \cond INTERNAL
void
Chat::RoomPrx::_iceI_SendMessage(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::std::shared_ptr<UserPrx>& iceP_who, const ::std::string& iceP_message, const ::std::string& iceP_passwd, const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
Chat::RoomPrx::_iceI_LeaveRoom(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::std::shared_ptr<UserPrx>& iceP_who, const ::std::string& iceP_passwd, const ::Ice::Context& context)
{
...
Chat::WrongPassword::_writeImpl(::Ice::OutputStream* ostr) const
{
    ...
    ::Ice::StreamWriter< WrongPassword, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}
...
{
    istr->startSlice();
    ::Ice::StreamReader< WrongPassword, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}
/// \endcond
...
::Ice::AsyncResultPtr
IceProxy::Chat::Room::_iceI_begin_ChangePassword(const ::Chat::UserPrx& iceP_user, const ::std::string& iceP_oldpassword, const ::std::string& iceP_newpassword, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    _checkTwowayOnly(iceC_Chat_Room_ChangePassword_name, sync);
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_Chat_Room_ChangePassword_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_Chat_Room_ChangePassword_name, ::Ice::Normal, context);
        ::Ice::OutputStream* ostr = result->startWriteParams(::Ice::DefaultFormat);
        ostr->write(iceP_user);
        ostr->write(iceP_oldpassword);
        ostr->write(iceP_newpassword);
        result->endWriteParams();
        result->invoke(iceC_Chat_Room_ChangePassword_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
void
IceProxy::Chat::Room::end_ChangePassword(const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_Chat_Room_ChangePassword_name);
    if(!result->_waitForResponse())
    {
        try
        {
