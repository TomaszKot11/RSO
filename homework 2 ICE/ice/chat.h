...
using UsernamesWithPasswordList = ::std::map<::std::string, ::std::string>;
...
public:
    ...
    virtual void ChangePassword(::std::shared_ptr<UserPrx> user, ::std::string oldpassword, ::std::string newpassword, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
...
public:
    ...
    void ChangePassword(const ::std::shared_ptr<UserPrx>& user, const ::std::string& oldpassword, const ::std::string& newpassword, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        _makePromiseOutgoing<void>(true, this, &RoomPrx::_iceI_ChangePassword, user, oldpassword, newpassword, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto ChangePasswordAsync(const ::std::shared_ptr<UserPrx>& user, const ::std::string& oldpassword, const ::std::string& newpassword, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<void>>().get_future())
    {
        return _makePromiseOutgoing<void, P>(false, this, &RoomPrx::_iceI_ChangePassword, user, oldpassword, newpassword, context);
    }

    ::std::function<void()>
    ChangePasswordAsync(const ::std::shared_ptr<UserPrx>& user, const ::std::string& oldpassword, const ::std::string& newpassword,
                        ::std::function<void()> response,
                        ::std::function<void(::std::exception_ptr)> ex = nullptr,
                        ::std::function<void(bool)> sent = nullptr,
                        const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &RoomPrx::_iceI_ChangePassword, user, oldpassword, newpassword, context);
    }

    /// \cond INTERNAL
    void _iceI_ChangePassword(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>&, const ::std::shared_ptr<UserPrx>&, const ::std::string&, const ::std::string&, const ::Ice::Context&);
    /// \endcond
...
/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::Chat::Room::begin_ChangePassword.
 * Create a wrapper instance by calling ::Chat::newCallback_Room_ChangePassword.
 */
class Callback_Room_ChangePassword_Base : public virtual ::IceInternal::CallbackBase { };
...
public:
    ...
    void ChangePassword(const ::Chat::UserPrx& user, const ::std::string& oldpassword, const ::std::string& newpassword, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_ChangePassword(_iceI_begin_ChangePassword(user, oldpassword, newpassword, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_ChangePassword(const ::Chat::UserPrx& user, const ::std::string& oldpassword, const ::std::string& newpassword, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_ChangePassword(user, oldpassword, newpassword, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_ChangePassword(const ::Chat::UserPrx& user, const ::std::string& oldpassword, const ::std::string& newpassword, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_ChangePassword(user, oldpassword, newpassword, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_ChangePassword(const ::Chat::UserPrx& user, const ::std::string& oldpassword, const ::std::string& newpassword, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_ChangePassword(user, oldpassword, newpassword, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_ChangePassword(const ::Chat::UserPrx& user, const ::std::string& oldpassword, const ::std::string& newpassword, const ::Chat::Callback_Room_ChangePasswordPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_ChangePassword(user, oldpassword, newpassword, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_ChangePassword(const ::Chat::UserPrx& user, const ::std::string& oldpassword, const ::std::string& newpassword, const ::Ice::Context& context, const ::Chat::Callback_Room_ChangePasswordPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_ChangePassword(user, oldpassword, newpassword, context, cb, cookie);
    }
...
public:
    ...
    virtual void ChangePassword(const UserPrx& user, const ::std::string& oldpassword, const ::std::string& newpassword, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_ChangePassword(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Chat::Room::begin_ChangePassword.
 */
